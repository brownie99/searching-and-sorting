                ...
                if (validInt)
                {
                    switch (selection)
                    {
                        ...
                        case 4:
                            Console.WriteLine("High-256 Selected");
                            validSelection = true;
                            float[] low2048Arr = new float[256];
                            read(low2048Arr, "High_256.txt");
                        ...
                        case 5:
                            Console.WriteLine("High-256 Selected");
                            validSelection = true;
                            float[] mean2048Arr = new float[256];
                            read(mean2048Arr, "High_256.txt");
                        ...
                        case 6:
                            Console.WriteLine("High-256 Selected");
                            validSelection = true;
                            float[] high2048Arr = new float[256];
                            read(high2048Arr, "High_256.txt");
                        ...
                        case 7:
                            Console.WriteLine("High-256 Selected");
                            validSelection = true;
                            float[] low4096Arr = new float[256];
                            read(low4096Arr, "High_256.txt");
                        ...
                        case 8:
                            Console.WriteLine("High-256 Selected");
                            validSelection = true;
                            float[] mean4096Arr = new float[256];
                            read(mean4096Arr, "High_256.txt");
                        ...
                        case 9:
                            Console.WriteLine("High-256 Selected");
                            validSelection = true;
                            float[] high4096Arr = new float[256];
                            read(high4096Arr, "High_256.txt");
